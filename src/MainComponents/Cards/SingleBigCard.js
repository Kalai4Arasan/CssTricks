        ...
        var $window = $(window);
            ...
            $window.scroll(function() {
                ...
                if ( $window.scrollTop() >= fixing ) {
                    $('#fixing').css({'position':'fixed','top':$window.scrollTop()-1650})
    ...
    render() { 
        return ( 
            ...
            <div class="ui grid" style={{marginTop:'10%'}}>
                <div id="ad" class="four wide computer only column" style={{marginLeft:'5%',marginTop:'10%'}}>
                    <div>
            ...
            <div id="end" style={{marginBottom:'5%'}} class="ui grid">
                ...
                <button style={{height:'60px',background:'linear-gradient(to top left,#ff8a00,#e52e71)',color:'white',fontSize:'20px'}} class="ui button ten wide column">Keep browsing in the archives</button>
            </div>
            </>
         );
    }
