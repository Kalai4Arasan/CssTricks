    ...
    render() { 
        return ( 
            <div style={{marginTop:'10%'}} class="ui container grid">
                <div class="four wide column" style={{marginTop:'3%'}}>
                    <div class="ui card" style={{border:'black',background:'linear-gradient(0deg,#ff8a00,#e52e71)',borderRadius:'20px',height:'93%',width:'120%'}}>
