    ...
    render() { 
        return ( 
            ...
            <div class="ui computer only grid" style={{marginTop:'10%'}}>
                ...
                <div class="row" style={{display:'flex',marginTop:'-30px'}}>
                        ...
                        <div >
                            <div class="ui card " id="mixupCard2" style={{display:'flex',marginLeft:'-14px'}} >
                                <div class="content">
                                    ...
                                    <h4 class="textHover">Art Directing Images, the Picture Element, and Image CDNs</h4>
                                </div>
                                <div class="ui grid content">
                                    <div class="six wide column" >
                                    ...
                                    <div style={{marginTop:'1%'}} class="ten wide column" >
                                        <legend style={{marginLeft:'1%'}} ><h4 class="textHover">Running Time:<br/> 27:17</h4></legend>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div >
                            <div class="ui card " id="mixupCard3" >
                                <div class="content">
                                    <h1>Article <small style={{fontSize:'12px'}} class="transparent">{this.state.data[1].date}</small></h1> 
                                    <h4 class="textHover">{this.state.data[1].title}</h4>
                                </div>
                                <div class="ui grid content">
                                    <div class="six wide column" >
                                    <img class="ui circular image" style={{display:'flex',marginLeft:'8px'}}  src={window.location.origin+"/avatars/"+this.state.data[1].avatar}/>
                                                <svg height="60" width="60" style={{fill: 'none',stroke: 'url(#orange-to-pink)',strokeWidth: '8',strokeLinecap: 'round',display:'flex',marginTop:'-40px'}} id="half-circle" viewBox="0 0 106 57">
                                                    <defs>
                                                        <linearGradient id="orange-to-pink" x1="1" x2="0" y1="1" y2="0">
                                                        <stop offset="0%" stop-color="#DA1B60"></stop>
                                    ...
                                    <div style={{marginTop:'1%'}} class="eight wide column" >
                                        <legend style={{marginLeft:'1%'}} >Author<h4 class="textHover">{this.state.data[1].author}</h4></legend>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row" style={{display:'flex',marginTop:'-28px'}}>
                    <div class="three wide column"></div>
                    <div class="three wide column">
