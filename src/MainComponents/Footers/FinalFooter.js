            ...
            <div class="ui grid container" style={{marginTop:'4%'}}>
                ...
                <div class="row" style={{marginTop:'5%'}}>
                        ...
                        <div class="ui four wide column">
                            <h1>Other Navs</h1>
                            <table class="ui fixed table" style={{background:'#100e17',color:'white'}}>
                                <tr>
                                    <td>Contact</td>
                                    <td>About</td>
                                </tr>
                ...
                <div class="row" style={{marginTop:'5%'}}>
                    ...
                    <div class="five wide column" >
                        <div class=" ui card" id="codepen">
                            ...
                            <div class="content">
                                <h5>
                                CSS-Tricks is hosted by Flywheel, the best WordPress hosting in the business.
                                </h5>
                            </div>
                        </div> 
                    </div>
                    <div class="five wide column" >
                        <div class=" ui card" id="codepen">
                            <img style={{height:'90px',width:'90px'}} src="/icons/shoptalk.png"/>
                            <div class="content">
                                <h5>
